...
class update(Toplevel):
    def __init__(self,person_id):
        ...
        # top frame heading
        self.heading = Label(self.top, text="Update Person", font="arial 15 bold", bg="white", fg="#ebb434")
    ...
    def update_person(self):
        ...
        query = "update phonebook set person_name = '{}' ,person_surname = '{}' ,person_email = '{}' ,person_number = '{}' ,person_address = '{}' where person_id = {}".format(name,surname,email,number,address,id)
